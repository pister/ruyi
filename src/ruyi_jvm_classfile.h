...
typedef struct {
    ...
    JVM_cp_info    *constant_pool; //[constant_pool_count-1];
    u2             access_flags;
    u2             this_class;
    u2             super_class;
    u2             interfaces_count;
    ...
    u2             fields_count;
    JVM_field_info *fields; //[fields_count];
    u2             methods_count;
    JVM_method_info *methods; //[methods_count];
    u2             attributes_count;
    JVM_attribute_info *attributes; //[attributes_count];
} JVM_ClassFile;
